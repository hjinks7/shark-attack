...
- **There are some countries with Bayesian-weighted fatality rates well above the world average**. These represent a stronger indicator of actual risk compared to the above per-capita island effect, because the Bayesian-weighted high fatality rate cannot be accounted for by small sample size.
